 ...
 */
window.returnTXL.onlick(function(){
	window.location.href="txl.jsp";
})
window.Modernizr = function(e, t, n) {
		...
		for(var B in y) k(y, B) && (x = B.toLowerCase(), i[x] = y[B](), E.push((i[x] ? "" : "no-") + x));
		return i.input || H(), i.addTest = function(e, t) {
				if(typeof e == "object")
					for(var r in e) k(e, r) && i.addTest(r, e[r]);
				else {
					e = e.toLowerCase();
					if(i[e] !== n) return i;
